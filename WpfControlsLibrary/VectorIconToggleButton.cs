...
namespace WpfControlsLibrary
{
    ...
    ///
    ///     <MyNamespace:VectorIconToggleButton/>
    ///
    /// </summary>
    public class VectorIconToggleButton : ToggleButton
    {
        static VectorIconToggleButton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(VectorIconToggleButton), new FrameworkPropertyMetadata(typeof(VectorIconToggleButton)));
        }
        ...
        public static readonly DependencyProperty VectorIconPathProperty =
            DependencyProperty.Register("VectorIconPath", typeof(string), typeof(VectorIconToggleButton), new PropertyMetadata(null, OnVectorIconPathChanged));
        ...
        public static readonly DependencyProperty IconDrawingImageProperty =
            DependencyProperty.Register("IconDrawingImage", typeof(DrawingImage), typeof(VectorIconToggleButton), new PropertyMetadata(null, OnIconDrawingImageChanged));
        ...
        public static readonly DependencyProperty BlurIconDrawingImageProperty =
            DependencyProperty.Register("BlurIconDrawingImage", typeof(DrawingImage), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty DisabledIconDrawingImageProperty =
            DependencyProperty.Register("DisabledIconDrawingImage", typeof(DrawingImage), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CaptionProperty =
            DependencyProperty.Register("Caption", typeof(string), typeof(VectorIconToggleButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IconFillBrushProperty =
            DependencyProperty.Register("IconFillBrush", typeof(Brush), typeof(VectorIconToggleButton), new PropertyMetadata(null, (d, e) =>
            {
                VectorIconToggleButton viButton = d as VectorIconToggleButton;
                if (viButton != null)
                {
        ...
        {
            (d as VectorIconToggleButton).ConvertSVGToXaml(e.NewValue as string);
        }
